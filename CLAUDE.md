...
- **`docs/DOCTRINE_LEDGER.md`** — all 30 BINDING doctrines + candidates (#27 reserved for R25 P3 CRYPTO-CTC pending · #31 ratified 2026-05-14 DOC-PUSHBACK-WITH-REPLACEMENT)
