// CMD-W27-A · Generic scraper safety · World-A↔World-B firewall (runtime assertion)
// Originally lifted from lib/fb-army-safety/isolation.ts (W24-L1).
// ABSOLUTE: any World-B prong (own-infra droplet · burner · Manus task · etc.)
// MUST NEVER carry any World-A (official channel · e.g. Meta Graph API)
...
// Companion to fb-army/src/proxy-egress.ts `assertEgressSafety()` (if/when active).
