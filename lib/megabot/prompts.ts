...
Return JSON with: buyer_profiles[] (6-12 profiles: profile_name, buyer_type, motivation, price_sensitivity, likelihood_to_buy, estimated_offer_range, platforms_active_on[], best_approach), platform_opportunities[] (5-10: platform, opportunity_level, estimated_buyers, avg_sale_price_here, search_terms_buyers_use[], groups_or_communities[], best_time_to_post), outreach_strategies[] (3-6: strategy_name, channel, message_template, expected_response_rate, effort_level), local_opportunities (antique_shops_nearby, flea_markets, consignment_options), hot_leads[] (3-8 real-person leads · skill 01 5-field rule + 2 carries · each lead MUST have: platform (eBay/Reddit/FB Marketplace/forum-name), buyer_identifier (username/handle/profile-URL/group-name+post-URL — NEVER 'collectors of X'), intent_signal (exact-quote OR hashtag OR search-history-hint), recency (ISO date or 'X days ago'), path_to_contact (DM-link/email/group-post-URL/forum-PM), urgency (Act now|This week|This month), estimated_price_usd. Skill 01 governs: fewer real leads, not more fake personas. Floor 0 if signal doesn't support · ceiling 8 — DO NOT pad.), competitive_landscape (similar_items_listed, price_range_of_competitors, your_advantage, differentiation_tip), timing_advice (best_day_to_list, seasonal_peak, urgency_recommendation), executive_summary (4-6 sentences for senior).
