// CMD-W24-L1 · FB-Army Meta-Safety · hardcoded pace floor
// NO env override · NO Sleep(0) · NO downgrade path. CEO Meta-safety law.
//
// Wraps fb-army/src/fingerprint.ts DEFAULT_PACE — verifies any caller-supplied
// PaceProfile meets or exceeds the absolute floors below. Anything faster is
// rejected (refuse-to-run). Slower (more conservative) is permitted.
