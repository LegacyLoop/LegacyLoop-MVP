              ...
              <div>
                ...
                {val.fair_market_value?.mid && (
                  <div style={{
                    ...
                    <div style={{ textAlign: "center" as const }}>
                      <div style={{ fontSize: "0.48rem", textTransform: "uppercase" as const, letterSpacing: "0.08em", color: "var(--text-muted)", fontWeight: 700 }}>Legacy-Loop Fee</div>
            ...
            {reportOpen && (
              <div style={{ marginTop: "0.75rem", border: `2px solid ${GOLD}`, borderRadius: "1rem", padding: "1.5rem", background: "var(--bg-card)" }}>
                ...
                <div style={{ textAlign: "center" as const, marginBottom: "1rem", paddingBottom: "0.75rem", borderBottom: `1px dashed ${GOLD_BORDER}` }}>
                  <div style={{ fontSize: "0.6rem", fontWeight: 700, color: GOLD, letterSpacing: "0.2em", textTransform: "uppercase" as const }}>═══ Legacy-Loop Antique Appraisal Report ═══</div>
                ...
                <div style={{ padding: "0.75rem", background: `${GOLD}04`, borderRadius: "0.5rem", fontSize: "0.68rem", color: "var(--text-muted)", fontStyle: "italic" as const, lineHeight: 1.5 }}>
                  ⚠️ This report is generated by Legacy-Loop AI and is not a substitute for a certified professional appraisal. In-person examination recommended for items valued over $500.
                  <div style={{ marginTop: "0.3rem", fontStyle: "normal" as const, fontSize: "0.6rem" }}>Report ID: {selectedId?.slice(0, 8)} · Generated by Legacy-Loop.com</div>
                </div>
                ...
                <div style={{ display: "flex", gap: "0.75rem", marginTop: "1rem" }}>
                  ...
                  <button onClick={() => {
                    ...
                    lines.push("Generated by Legacy-Loop.com");
