          ...
          {reportOpen && (
            <div style={{ marginTop: "0.5rem", padding: "1.5rem", border: "2px solid rgba(139,92,246,0.25)", borderRadius: "1rem", background: "var(--bg-card)" }}>
              ...
              <div style={{ textAlign: "center" as const, marginBottom: "1rem" }}>
                <div style={{ fontSize: "0.6rem", fontWeight: 700, color: "#8b5cf6", letterSpacing: "0.2em", textTransform: "uppercase" as const }}>═══ Legacy-Loop Multi-AI Consensus Report ═══</div>
              ...
              <div style={{ padding: "0.65rem 0.85rem", borderRadius: "0.5rem", background: "rgba(139,92,246,0.04)", fontSize: "0.68rem", color: "var(--text-muted)", lineHeight: 1.5, fontStyle: "italic" as const }}>
                ⚠️ This report is generated by Legacy-Loop AI using 4 independent AI engines (OpenAI, Claude, Gemini, Grok) running in parallel. Results represent AI consensus, not certified appraisal. Professional evaluation recommended for items valued over $500.
                <div style={{ marginTop: "0.3rem", fontSize: "0.6rem", fontStyle: "normal" as const }}>Report ID: {selectedId?.slice(0, 8)} · Generated by Legacy-Loop.com</div>
              </div>
              ...
              <div style={{ display: "flex", gap: "0.75rem", marginTop: "1rem" }}>
                ...
                <button onClick={() => {
                  ...
                  lines.push("Generated by Legacy-Loop.com — AI Consensus Report");
