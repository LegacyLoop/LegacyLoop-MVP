...
- All prices in USD.`;
    ...
    const requiredFields = [
      ...
      "valuation", "collector_market", "selling_strategy", "documentation", "executive_summary",
    ];
...
function generateDemoResult(
  ...
  return {
    ...
    authentication: {
      ...
      confidence: 72,
      reasoning: `Based on the ${material} construction, ${era} styling, and ${markings !== "None identified" ? "visible maker's marks" : "period-appropriate details"}, this ${itemName} appears to be a genuine ${era} piece. The ${conditionLabel.toLowerCase()} condition is consistent with authentic age-related wear.`,
      red_flags: conditionScore >= 8 ? ["Unusually good condition for stated age — verify provenance"] : [],
      positive_indicators: [
      ...
      appraiser_recommendation: revisedHigh > 500
