...
export default function TradeToggle({ itemId, initialEnabled }: { itemId: string; initialEnabled?: boolean }) {
  ...
  return (
    <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderLeft: "3px solid #00bcd4", borderRadius: 12, padding: "16px 20px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16 }}>
      <div>
      ...
      <button onClick={toggle} disabled={loading} style={{ width: 44, height: 24, borderRadius: 12, background: enabled ? "#00bcd4" : "rgba(255,255,255,0.15)", border: "none", cursor: loading ? "wait" : "pointer", position: "relative", transition: "background 0.2s", flexShrink: 0, padding: 0 }}>
