...
export default function WhatsNewPage() {
  const updates = [
    ...
    { date: "Mar 31, 2026", badge: null, title: "⚖️ Meta API Compliance", desc: "Data deletion page, updated privacy policy with Stripe/Meta/cookies, About page with full mission and values." },
    ...
    { date: "Mar 3, 2026", badge: null, title: "💳 Stripe Payment Integration", desc: "Stripe for subscriptions, credits, and purchases. PaymentLedger and SellerEarnings models." },
