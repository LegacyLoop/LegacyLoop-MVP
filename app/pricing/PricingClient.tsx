...
const DIGITAL_TIERS = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: "50 credits/month included", enabled: true },
      { text: "MegaBot (credit-based)", enabled: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "100 credits/month included", enabled: true },
      { text: "MegaBot (credit-based)", enabled: true },
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.82rem" }}>
                ...
                <tbody>
                  {[
                    ...
                    { label: "MegaBot (4-AI)", values: ["—", "—", "—", "5×/mo", "Unlimited", "Unlimited"] },
                    { label: "Monthly Credits", values: ["—", "—", "20/mo", "20/mo", "50/mo", "100/mo"] },
